...
def contact_checkbox(request):
    ...
    return render(request, 'demo_app/contact_checkbox.html', {
        'form': form,
...
def contact_invisible(request):
    ...
    return render(request, 'demo_app/contact_invisible.html', {
        'form': form,
...
def simple_form(request):
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            messages.success(
                request,
                f'Thank you, {name}! (No reCAPTCHA on this form)'
            )
            return redirect('success')
    else:
        form = SimpleForm()

    return render(request, 'demo_app/simple_form.html', {
        'form': form,
...
def csp_info(request):
    ...
    return render(request, 'demo_app/csp_info.html', {
        'csp_nonce': csp_nonce,
    })
